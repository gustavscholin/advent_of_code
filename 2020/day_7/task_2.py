def bags_inside(rules, bag_color):
    ...
    if not rules[bag_color]["children_colors"]:
        ...
        return sum(
            [
                child_cnt + child_cnt * bags_inside(rules, child_color)
                for child_color, child_cnt in zip(children_colors, children_cnts)
            ]
        )
...
if __name__ == "__main__":
    rules = read_input("2020/day_7/input.txt")
